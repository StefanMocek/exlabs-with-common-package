...
describe("UserModelService", () => {
  ...
  it("should create a new user", async () => {
    ...
    jest
      ...
      .mockResolvedValueOnce(newUser as UserDoc);
  ...
  it("should update a user", async () => {
    ...
    jest
      ...
      .mockResolvedValueOnce(updatedUser as UserDoc);
  ...
  it("should delete a user", async () => {
    ...
    jest
      .spyOn(User, "findOneAndRemove")
      .mockResolvedValueOnce(deletedUser as UserDoc);
